...
FeatureSelection_SVR <- function(target, predictors, method, train_set) {
  ...
  #create a learner
  regressor_RF <- makeLearner("regr.svm",  predict.type = "response")
...
save(FeatureSelection_SVR, file = "FeatureSelection_SVR.rda")
