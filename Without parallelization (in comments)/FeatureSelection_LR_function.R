...
FeatureSelection_LR <- function(target, predictors, method, train_set) {
  ...
  #create a learner
  regressor_RF <- makeLearner("regr.lm",  predict.type = "response")
...
save(FeatureSelection_LR, file = "FeatureSelection_LR.rda")
